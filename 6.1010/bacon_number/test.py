...
# own test case for acted_together
...
# own tiny test cases for bacon number
def test_tiny_bacon_number_0():
    # Bacon number, tiny database, just Kevin, my man
    n = 0
    expected = {4724}
...
def test_tiny_bacon_number_01():
    # Bacon number, tiny database, length of 2
    n = 1
    expected = {2876, 1532}
...
def test_tiny_bacon_number_02():
    # Bacon number, tiny database, length of 1
    n = 2
    expected = {1640}
...
def test_tiny_bacon_number_03():
    # Bacon number, tiny database, set is empty
    n = 3
    expected = set()
...
# own actor_to_actor test
def test_actor_to_actor_path_09():
    # actor path that exists
    x = 1375412
    y = 148096
    p = lab.actor_to_actor_path(db_large, x, y)
    e = [1375412, 131431, 8516, 1243, 4726, 148096]
